...
import 'package:bidhannagarpoliceapp/saraiolddoc.dart';
import 'package:bidhannagarpoliceapp/tenantregistration.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;

class saraioldpage extends StatefulWidget {
  ...
  @override
  State<saraioldpage> createState() => _saraioldpageState();
}

class _saraioldpageState extends State<saraioldpage> {
...
print('createStatus:$createStatus');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: isDark ? Colors.black : const Color(0xFFe9e4de),
        title: const Text('Sarai Application For Renewal'),
      ),
              ...
              ElevatedButton.icon(
                onPressed: () {
                  Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                      builder:
                          (context) => saraiolddocpage(
                            onThemeChanged:widget. onThemeChanged, 
                          isDarkMode:widget. isDarkMode)
                          
                          // docsdownviewpage(
                          //   filePath: 'assets/images/saraold_documetation.pdf',
