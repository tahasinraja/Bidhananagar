...
class webvieworganizationpage extends StatefulWidget {
  final Function(bool) onThemeChanged;
  final bool isDarkMode;

  const webvieworganizationpage({
    super.key,
  ...
  @override
  State<webvieworganizationpage> createState() => _webvieworganizationpageState();
}

class _webvieworganizationpageState extends State<webvieworganizationpage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: InAppWebView(
  initialUrlRequest: 
  URLRequest(url: WebUri("https://bnpcdeveloper.co.in/bnpolice/organizationprofile.php")),
